...
import org.skcorg.springsecurity.model.CreateEventForm;
...
public class EventsController {
	...
	public String createEventFormAutoPopulate(
			@ModelAttribute CreateEventForm createEventForm) {
		// provide default values to make user submission easier
		createEventForm.setSummary("A new event....");
		createEventForm
				.setDescription("This was autopopulated to save time creating a valid event.");
	...
	public String createEvent(@Valid CreateEventForm createEventForm,
		...
		String email = createEventForm.getAttendeeEmail();
		CalendarUser attendee = calendarService.findUserByEmail(email);
		if (attendee == null) {
