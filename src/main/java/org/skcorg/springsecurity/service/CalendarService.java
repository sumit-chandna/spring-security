...
public interface CalendarService {
	 ...
	 *
	 * @param id
	 *            the {@link CalendarUser#getId()} of the {@link CalendarUser}
	 *            to find.
	 ...
	 *
	 * @param email
	 *            the email address to use to find a {@link CalendarUser}.
	 *            Cannot be null.
	 * @return a {@link CalendarUser} for the given email or null if one could
	 *         not be found.
	...
	/**
	 * Finds any {@link CalendarUser} that has an email that starts with
	 * {@code partialEmail}.
	 *
	 * @param partialEmail
	 *            the email address to use to find {@link CalendarUser}s. Cannot
	 *            be null or empty String.
	 * @return a List of {@link CalendarUser}s that have an email that starts
	 *         with given partialEmail. The returned value will never be null.
	 ...
	 *
	 * @param user
	 *            the new {@link CalendarUser} to create. The
	 *            {@link CalendarUser#getId()} must be null.
	 ...
	 *
	 * @param message
	 *            the {@link Event} to create. Note that the
	 *            {@link Event#getId()} should be null.
	 ...
	 *
	 * @param userId
	 *            the {@link CalendarUser#getId()} to obtain {@link Event}'s
	 *            for.
	 * @return a non-null {@link List} of {@link Event}'s intended for the
	 *         specified {@link CalendarUser}. If the {@link CalendarUser} does
